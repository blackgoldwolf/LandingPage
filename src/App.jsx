  ...
  return (
    <div className="min-h-screen flex flex-col text-white">
      <main className="container mx-auto px-6 pt-16 flex-1 text-center">
        ...
        <h1 className="text-3xl md:text-6xl 1g:text-8xl font-black uppercase mb-8">
          The Big Dick coding club
        </h1>
        ...
        <form
          action="https://www.getrevue.co/profile/blackgoldwolf/add_subscriber"
          method="post"
          target="_blank"
        >
          <div className="flex flex-col md:flex-row justify-center mb-4">
            ...
            <input
              ...
              className="bg-primary rounded-full md:rounded-tl-none md:rounded-bl-none text-large md:text-2xl py-4 px-6 md:px-10 lg:py-6 lg:px-12 cursor-pointer hover:opacity-75 duration-150"
            />
          </div>
      ...
      <footer className="container mx-auto p-6 flex flex-col md:flex-row items-center justify-between">
        <p>Built with love by Luke Lippincott</p>
